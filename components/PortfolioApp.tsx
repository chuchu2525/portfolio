    ...
    <>
      ...
      <main id="top">
        <section className="relative grid min-h-[calc(100vh-84px)] grid-cols-1 items-center gap-[clamp(28px,5vw,72px)] border-x border-dashed border-[rgba(189,194,255,0.25)] px-[clamp(18px,5vw,72px)] py-[clamp(48px,7vw,96px)] [background:linear-gradient(90deg,rgba(26,35,126,0.95),rgba(26,35,126,0.82)),repeating-linear-gradient(45deg,rgba(255,255,255,0.025)_0_2px,transparent_2px_5px)] before:absolute before:inset-y-0 before:left-[5.2vw] before:border-l before:border-dashed before:border-[rgba(189,194,255,0.32)] after:absolute after:inset-y-0 after:right-[5.2vw] after:border-l after:border-dashed after:border-[rgba(189,194,255,0.32)] md:grid-cols-[minmax(0,1fr)_minmax(260px,340px)] lg:grid-cols-[minmax(0,1fr)_minmax(340px,520px)]">
          ...
          <div className="relative aspect-square w-[min(100%,420px)] justify-self-center rounded-xl border-[5px] border-[#343434] bg-[#111] shadow-[0_28px_60px_rgba(0,0,0,0.55),inset_0_2px_8px_rgba(255,255,255,0.07)] md:w-[min(100%,340px)] lg:w-[min(100%,520px)]" aria-label="Skill radar preview">
            <div className="absolute inset-[8%] rounded-full bg-[#0a0a0a]" />
            <div className="record-grooves motion-safe-spin absolute inset-[9%] z-[1] rounded-full shadow-[0_18px_34px_rgba(0,0,0,0.7)] [animation:slow-spin_46s_linear_infinite]">
              <div className="record-shine absolute inset-0 rounded-[inherit]" />
            </div>
            <div className="record-radar-surface pointer-events-none absolute inset-[10.5%] z-[2] grid place-items-center rounded-full">
              <HeroRadar />
              <span className="absolute size-[18px] rounded-full border border-[#3d2f00] bg-[radial-gradient(circle_at_35%_30%,#fff2a5,var(--yellow-2)_54%,#4a3900)]" />
            </div>
            <div className="pointer-events-none absolute inset-[10.5%] z-[3] rounded-full" aria-hidden="true">
            ...
            <div className="absolute right-[7%] bottom-[7%] z-[4] flex gap-2.5 whitespace-nowrap text-[10px] font-extrabold tracking-[0.12em] text-[var(--muted)]" aria-hidden="true">
              <span className="rounded-full border border-[rgba(185,181,197,0.28)] bg-[rgba(7,7,7,0.42)] px-2 py-1">EXPERIENCE SCORE</span>
